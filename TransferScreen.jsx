import { StyleSheet, Text, View, Image, SafeAreaView, TextInput,Button,Alert,TouchableHighlight,CheckBox } from 'react-native';
    ...
    return(
        <SafeAreaView style={{flex: 1}}>
            <View style={styles.container}>
                ...
                <View style={{marginTop: 30,width: "100%",height: 165,backgroundColor: "white",paddingHorizontal: 30}}>
